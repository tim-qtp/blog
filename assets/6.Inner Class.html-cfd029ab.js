import{_ as t,W as c,X as i,$ as n,a0 as s,Z as e,a2 as p,C as o}from"./framework-6a3aa88c.js";const l={},u=p(`<h3 id="_1、成员内部类" tabindex="-1"><a class="header-anchor" href="#_1、成员内部类" aria-hidden="true">#</a> 1、成员内部类</h3><p>成员内部类是最常见的内部类，看下面的代码：</p><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token keyword">class</span> <span class="token class-name">Wanger</span> <span class="token punctuation">{</span>
