...
BMC
   ↓
物理服务器硬件
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>理解了这条链路，IPMI、BMC、RMCP+、带外管理以及后续的 Redfish 就基本串起来了。</p>`,235),l=[s];function r(t,v){return i(),n("div",null,l)}const u=e(d,[["render",r],["__file","1.从ipmitool-lanplus讲清楚IPMI-BMC-RMCP与带外管理.html.vue"]]);export{u as default};
