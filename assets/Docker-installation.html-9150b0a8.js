import{_ as t,W as c,X as r,$ as e,a1 as n,Z as a,a2 as i,C as o}from"./framework-48328e23.js";const l={},d=e("p",null,"Docker 分为 CE 和 EE 两大版本。CE 即社区版（免费，支持周期 7 个月），EE 即企业版，强调安全，付费使用，支持周期 24 个月。",-1),p=e("p",null,[n("Docker CE 分为 "),e("code",null,"stable"),n(),e("code",null,"test"),n(" 和 "),e("code",null,"nightly"),n(" 三个更新频道。")],-1),u={href:"https://docs.docker.com/install/",target:"_blank",rel:"noopener noreferrer"},m=i(`<h2 id="_1-centos安装docker" tabindex="-1"><a class="header-anchor" href="#_1-centos安装docker" aria-hidden="true">#</a> 1.CentOS安装Docker</h2><p>Docker CE 支持 64 位版本 CentOS 7，并且要求内核版本不低于 3.10， CentOS 7 满足最低内核的要求，所以我们在CentOS 7安装Docker。</p><h3 id="_1-1-卸载-可选" tabindex="-1"><a class="header-anchor" href="#_1-1-卸载-可选" aria-hidden="true">#</a> 1.1.卸载（可选）</h3><p>如果之前安装过旧版本的Docker，可以使用下面命令卸载：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>yum remove docker \\
                  ...
                  docker-engine \\
                  docker-ce
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,5),v={href:"https://cloud.tencent.com/document/product/1207/45596?cps_key=1d358d18a7a17b4a6df8d67a62fd3d3d",target:"_blank",rel:"noopener noreferrer"},k=i(`<h3 id="_1-2-安装docker" tabindex="-1"><a class="header-anchor" href="#_1-2-安装docker" aria-hidden="true">#</a> 1.2.安装docker</h3><p>首先需要大家虚拟机联网，安装yum工具</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>yum <span class="token function">install</span> <span class="token parameter variable">-y</span> yum-utils <span class="token punctuation">\\</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://qtp-1324720525.cos.ap-shanghai.myqcloud.com/blog/74f887efd46039a6b5f227fb0208ab18.png" alt="image-20230612113657485" tabindex="0" loading="lazy"><figcaption>image-20230612113657485</figcaption></figure><h3 id="_1-4-配置镜像加速" tabindex="-1"><a class="header-anchor" href="#_1-4-配置镜像加速" aria-hidden="true">#</a> 1.4.配置镜像加速</h3><p>docker官方镜像仓库网速较差，我们需要设置国内镜像服务：</p>`,24),b={href:"https://cr.console.aliyun.com/cn-hangzhou/instances/mirrors",target:"_blank",rel:"noopener noreferrer"},h=i(`<div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">sudo</span> <span class="token function">mkdir</span> <span class="token parameter variable">-p</span> /etc/docker
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>如果下载速度较慢，或者下载失败，可以使用资料的docker-compose文件：</p><figure><img src="https://qtp-1324720525.cos.ap-shanghai.myqcloud.com/blog/3fc8ccb6a2eb5fca9bc3b85fb00c6b8b.png" alt="image-20210417133020614" tabindex="0" loading="lazy"><figcaption>image-20210417133020614</figcaption></figure><p>上传到<code>/usr/local/bin/</code>目录也可以。</p><p>我这里放一个下载链接，是我的腾讯云存储桶：</p>`,9),g={href:"https://qtp-1324720525.cos.ap-shanghai.myqcloud.com/blog-bigfile/docker-compose",target:"_blank",rel:"noopener noreferrer"},f=i(`<h3 id="_2-2-修改文件权限" tabindex="-1"><a class="header-anchor" href="#_2-2-修改文件权限" aria-hidden="true">#</a> 2.2.修改文件权限</h3><p>修改文件权限：</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 修改权限</span>
...
<span class="token function">curl</span> <span class="token parameter variable">-L</span> https://raw.githubusercontent.com/docker/compose/1.29.1/contrib/completion/bash/docker-compose <span class="token operator">&gt;</span> /etc/bash_completion.d/docker-compose
    ...
    registry
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>命令中挂载了一个数据卷registry-data到容器内的/var/lib/registry 目录，这是私有镜像库存放数据的目录。</p>`,5),x={href:"http://YourIp:5000/v2/_catalog",target:"_blank",rel:"noopener noreferrer"},q=i(`<h3 id="_3-2-带有图形化界面版本" tabindex="-1"><a class="header-anchor" href="#_3-2-带有图形化界面版本" aria-hidden="true">#</a> 3.2.带有图形化界面版本</h3><p>使用DockerCompose部署带有图象界面的DockerRegistry，命令如下：</p><div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code><span class="token key atrule">version</span><span class="token punctuation">:</span> <span class="token string">&#39;3.0&#39;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,9);function D(E,C){const s=o("ExternalLinkIcon");return c(),r("div",null,[d,p,e("p",null,[n("官方网站上有各种环境下的 "),e("a",u,[n("安装指南"),a(s)]),n("，这里主要介绍 Docker CE 在 CentOS上的安装。")]),m,e("p",null,[e("a",v,[n("腾讯云安装 Docker 并配置镜像加速源"),a(s)])]),k,e("p",null,[n("参考阿里云的镜像加速文档："),e("a",b,[n("https://cr.console.aliyun.com/cn-hangzhou/instances/mirrors"),a(s)])]),h,e("p",null,[e("a",g,[n("docker-compose"),a(s)])]),f,e("p",null,[n("官网地址："),e("a",_,[n("https://hub.docker.com/_/registry"),a(s)])]),y,e("p",null,[n("访问"),e("a",x,[n("http://YourIp:5000/v2/_catalog"),a(s)]),n(" 可以查看当前私有镜像服务中包含的镜像")]),q])}const I=t(l,[["render",D],["__file","Docker-installation.html.vue"]]);export{I as default};
